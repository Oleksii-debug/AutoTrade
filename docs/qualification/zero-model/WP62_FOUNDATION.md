...
continuity, paper-trading host/UI continuity, real provider minimums/lot-size economics, or
authority workflows during a real local/remote model outage. The small-capital
check here is only the deterministic simulator's insufficient-cash boundary. It does not establish
