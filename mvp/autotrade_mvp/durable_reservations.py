...
class DurableReservationBook:
    ...
    def state_digest(self) -> str:
        ...
        The digest is intentionally independent from process-local projection
        objects.  A proposal can therefore bind to version *and* content, and a
        restarted financial writer can reproduce the same identity.
        """
