...
class ExperienceMemoryStore:
    ...
    def append(
        ...
        *,
        ...
        self._require_text(episode_id, "episode_id")
        self._require_text(decision_id, "decision_id")
        self._require_text(evidence_cutoff, "evidence_cutoff")
        self._require_text(source_version, "source_version")
        ...
        with self._connect() as connection:
            ...
            if existing is not None:
                exact = (
                    ...
                    and existing["evidence_cutoff"] == evidence_cutoff
            ...
            connection.execute(
                ...
                INSERT INTO experiences(
                    episode_id, decision_id, evidence_cutoff, action_ref, execution_ref,
                    outcome_class, outcome_json, source_version, supersedes_episode_id, created_at
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                """,
                (
                    episode_id,
