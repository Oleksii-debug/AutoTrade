...
def _activity_identity(
    *, provider_id: str, account_id: str, activity_id: str
) -> str:
    provider = _text(provider_id, name="provider_id").upper()
    account = _text(account_id, name="account_id")
    activity = _text(activity_id, name="activity_id")
    return f"{provider}/{account}/{activity}"


def _book_id(*, provider_id: str, account_id: str) -> str:
    provider = _text(provider_id, name="provider_id").upper()
    account = _text(account_id, name="account_id")
...
def book_external_provider_cash_activity(
    ...
    *,
    ...
    book_id = _book_id(provider_id=provider, account_id=account)
...
def load_provider_account_economic_book(
    ...
    *,
    ...
    if not isinstance(store, JournalStore):
        raise TypeError("store must be JournalStore")
    book_id = _book_id(provider_id=provider_id, account_id=account_id)
