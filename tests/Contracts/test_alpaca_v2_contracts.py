...
from mvp.autotrade_mvp.alpaca_v2 import parse_submission_response
...
class AlpacaV2ContractTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.schemas = {
    ...
    def test_submission_response_matches_canonical_provider_contract(self):
