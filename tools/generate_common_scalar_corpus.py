...
CANDIDATES: tuple[tuple[str, str, object], ...] = (
    ...
    ("decimal-terminal-lf", "Decimal", "1\n"),
    ("decimal-terminal-crlf", "Decimal", "1\r\n"),
    ...
    ("sequence-terminal-lf", "Sequence", "1\n"),
    ("sequence-terminal-crlf", "Sequence", "1\r\n"),
    ("digest-valid", "Digest", "sha256:" + "a" * 64),
    ("digest-uppercase", "Digest", "sha256:" + "A" * 64),
    ("digest-wrong-length", "Digest", "sha256:" + "a" * 63),
    ("digest-terminal-lf", "Digest", "sha256:" + "a" * 64 + "\n"),
    ("digest-terminal-crlf", "Digest", "sha256:" + "a" * 64 + "\r\n"),
    ...
    ("currency-terminal-lf", "CurrencyId", "USD\n"),
    ("currency-terminal-crlf", "CurrencyId", "USD\r\n"),
    ("unit-simple", "UnitId", "shares"),
    ("unit-path", "UnitId", "contract/BTC-USD"),
    ("unit-space", "UnitId", "base units"),
    ("unit-too-long", "UnitId", "x" * 65),
    ("unit-terminal-lf", "UnitId", "shares\n"),
    ("unit-terminal-crlf", "UnitId", "shares\r\n"),
